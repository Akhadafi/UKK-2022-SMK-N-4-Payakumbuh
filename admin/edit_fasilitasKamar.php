...
$fasilitas_kamar = query("SELECT * FROM fasilitas_kamar WHERE fasilitas_kamar = '$id'")[0];
?>
<!DOCTYPE html>
<html>
      ...
      <form action="" method="post">
        ...
        <div class="modal-body">
          ...
          if (isset($_POST["edit"])) {
            ...
            if (edit_fasilitasKamar($_POST) > 0) {
              echo "
          <script>
        ...
        ";
          ...
          <div class="mb-2">
            ...
            <input name="fasilitas_kamar" type="text" class="text-light btn-outline-info form-control" style="background-color:transparent" id="fasilitas_kamar" placeholder="Tipe Kamar" value="<?= $fasilitas_kamar['fasilitas_kamar']; ?>">
          </div>
        </div>
